					   ...
					   {foreach key=key item=item from=$tiendas}
						  ...
						  <div class="item" title="{$tiendas[$key]['descripcion']}">
							  ...
							  <a href="{$tiendas[$key]['url']}" target="_blank">
									...
									<img class="img-item" src="{$tiendas[$key]['logo']}" alt="">
							  ...
							  <div class="item-descripcion">
								 ...
								 <div id="video-item" class="video-item">
									 <video onclick="this.paused ? this.play() : this.pause();" controls>
									  <source src="http://localhost/ecdc/multimedia/videos-tiendas/{$tiendas[$key]['desc_video']}" type="video/webm" />
									  
									  <!--<source src="https://elcomerciodecali.com.co/multimedia/videos-tiendas/{$tiendas[$key]['desc_video']}" type="video/webm" />-->
									 </video>
								 </div>
